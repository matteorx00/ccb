...
const Backend = (() => {
  ...
  return { useRemote, signup, login, submitScore, leaderboard, leaderboardBest, globalRanking, getProgress, addProgress, myScores, getUnlocks, markLevelDone, buyCharacter };
})();
