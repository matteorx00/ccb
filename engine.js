...
function triggerDash(){
  ...
  // Dash diagonal : on bride l'avance horizontale pour qu'elle ne dépasse jamais
  // celle d'un dash droit (sinon le dash haut projette trop loin en avant).
  if(dash.dy!==0){ dash.dx*=0.55; }
