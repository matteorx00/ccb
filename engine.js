...
function augmentLevel(){
  ...
  // dans les données de zone (LEVEL). Cette couche ne gère plus que le trampoline
  // caché de la zone 5. Le mur secret gris de la zone 10 a été retiré : il
  // apparaissait comme un gros rectangle gris parasite au-dessus de la zone.
  fixZone5Trampoline();
}
